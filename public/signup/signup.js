...
form.addEventListener("submit",  async (e) => {
   let res = await makeRequest('GET', '/CSE442-542/2023-Spring/cse-442g/project_s23-the-ai-violators/public/content/HandleSignup.php?username='+username.value+'&email='+email.value+'&password='+password.value)
   e.preventDefault()
