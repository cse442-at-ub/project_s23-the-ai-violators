...
<head>
    ...
    <link rel="stylesheet" href="/public/profile/profile_test.css">
        ...
        <div class="card mb-3">
            <div class="card-body align-items-center text-center">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 text-secondary">
                        <?php echo $userInfo[12] ?>
                    </div>
                </div>
                <hr>
                <div class="row">
                    <div class="col-sm-12">
                        <button class="btn btn-primary" onClick="window.location.href='/public/profileEdit'">Edit Profile</button>
                    </div>
                </div>
            </div>
        </div>
